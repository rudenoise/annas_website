...
- "Set the fee to £60 a session."
- "Change the email address to anna@example.com."
- "Rewrite the About paragraph to say…"
...
### Good to know
- Every change is saved as a new version, and the old ones are kept — nothing
  is ever lost, so you can't break anything permanently.
- If something doesn't look right, just tell me what you see and I'll fix it.
